const rawWords = [
  ...
  },
  {
    ...
    "usage": {
      "actionBtn": "🔍 Phân Rã Người Máy 3D",
      "actionType": "toy",
      "title": "Phân rã giáp ngực, tay, chân và đầu người máy như Iron Man",
      "steps": [
  ...
  },
  {
    ...
    "usage": {
      "actionBtn": "🔍 Phân Rã Xe Hơi 3D",
      "actionType": "vehicle",
      "title": "Phân rã mui kính, ghế da và khung gầm lơ lửng cực ngầu",
      "steps": [
  ...
  },
  {
    ...
    "usage": {
      "actionBtn": "🔍 Phân Rã Xe Đạp 3D",
      "actionType": "vehicle",
      "title": "Khám phá 356 linh kiện xe đạp phân rã lơ lửng và đạp xe quanh sân",
      "steps": [
  ...
  },
  {
    ...
    "usage": {
      "actionBtn": "🔍 Phân Rã Xe Tải 3D",
      "actionType": "vehicle",
      "title": "Phân rã cụm bánh xe và bồn chở sữa lơ lửng trong không gian",
      "steps": [
...
function openWord(rawItem) {
  ...
  if (usageCard && item.usage) {
    ...
    const floatText = $('#floatSimulateText');
    if (floatText) floatText.textContent = item.usage.actionBtn || 'Thử Dùng Ngay';
